...
export function useKeyboardShortcuts({
  ...
  const shortcuts: ShortcutAction[] = [
    ...
    { key: "7", ctrl: true, description: "Auto Rolling Straddle", category: "Navigation", action: () => navigate("/auto-rolling-straddle") },
    { key: "8", ctrl: true, description: "Vega Pulse", category: "Navigation", action: () => navigate("/vega-pulse") },
